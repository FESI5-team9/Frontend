    ...
    <div className="mb-6 animate-pulse bg-gray-100">
      <div className="flex w-full flex-col gap-6 bg-gray-100 tablet:h-[153px] tablet:flex-row">
        ...
        <div className="flex w-full flex-col bg-gray-100">
          <div className="flex h-6 w-6 items-center text-gray-300">♥♥♥♥♥</div>
          <p className="mt-[10px] inline-block h-3 w-full rounded-3xl bg-gray-300 text-sm"></p>
          <p className="mt-[5px] inline-block h-3 w-full rounded-3xl bg-gray-300 text-sm"></p>
          <span className="mt-[10px] inline-block h-3 w-[150px] rounded-3xl bg-gray-300 text-xs"></span>
          <span className="mt-2 inline-block h-3 w-[100px] rounded-3xl bg-gray-300"></span>
          ...
          <div className="flex w-full gap-3">
            <div className="mb-[18px] flex flex-col gap-1.5">
              <span className="flex items-center gap-2">
                ...
                <span className="inline-block h-5 w-20 max-w-[135px] truncate rounded-3xl bg-gray-300"></span>
              </span>
              <div className="flex items-center gap-3">
                <span className="flex h-5 w-[100px] gap-3 rounded-3xl bg-gray-300 text-sm"></span>
